...
def tune(m):
    '''
    [8]  12  9  4 +triple                 24 24 24
    [8]   9 12 17 +triple                 24 24 24
    [16] 12  9 [8] +dot 12                
    [4] +rest
    '''
    m += [72, 69, 64, 69, 72, 77, 72, 69], \
...
def tune1(m):
    m += [35]*8, \
         [24, 24, 24, 24, 24, 24, 4, 4]
    m += [35, 0, 35, 35, 35, 35, 35, 35], \
         [12, 16, 24, 24, 24, 24, 24, 24]
    m += [35, 35, 35, 0, 35, 35, 35, 35], \
         [4, 4, 12, 16, 24, 24, 24, 24]
    m += [35, 35, 35, 35, 35, 0, 35, 35], \
         [24, 24, 4, 4, 12, 16, 4, 4]
    m += [35]*8, \
         [4, 4, 4, 4, 4, 4, 4, 4]
    m += [35, 35, 35, 35, 35, 0, 35, 35], \
    ...
    m += [35]*8, \
         [4, 24, 24, 24, 24, 24, 24, 4]
    m += [35, 35, 0, 35, 35, 35, 35, 35], \
         [4, 12, 32, 24, 24, 24, 24, 24]
    m += [35, 35, 35, 35, 0, 35, 35, 35], \
         [24, 4, 4, 12, 16, 24, 24, 24]
    m += [35, 35, 35, 35, 35, 35, 0, 35], \
         [24, 24, 24, 4, 4, 12, 16, 24]
    m += [35]*8, \
         [24, 24, 24, 24, 24, 4, 4, 12]
    m += [0, 35, 35, 35, 35, 35, 35, 35], \
         [16, 4, 4, 4, 4, 4, 4, 4]
    m += [35]*8, \
         [4, 4, 4, 4, 4, 24, 24, 24]
    m += [35, 0], \
...
t5 = tracks.addTrack("Track 5")
t6 = tracks.addTrack("Track 6")
t7 = tracks.addTrack("Track 7")
t8 = tracks.addTrack("Track 8")
# tracks.setTempo(70 * 32)
tracks.setTempo(70 * 24)
t1.setInstrument("Pad 8 (sweep)", channel = 1, pitchShift = 12, volume = 100)
t2.setInstrument("Tuba", channel = 2, pitchShift = -48, volume = 80)
t3.setInstrument("Orchestral Harp", channel = 3, volume = 80)
t4.setInstrument("Orchestral Harp", channel = 4, pitchShift = -24, volume = 100)
t5.setInstrument("Orchestral Harp", channel = 9, pitchShift = 51 - 35, volume = 80)
t6.setInstrument("Orchestral Harp", channel = 9, pitchShift = 60 - 35, volume = 80)
t7.setInstrument("Electric Grand Piano", channel = 7, pitchShift = 12, volume = 120)
t8.setInstrument("Pad 7 (halo)", channel = 8, pitchShift = -12, volume = 120)
