...
#        self.monitorFreq = 0.1
    ...
    def updatePosition(self, pressure):
        ...
        if (newPosition == currentPosition):
            ...
            self.printMessage("pressure {:.3e} , moving device to {}".format(pressure, newPosition))
...
# maxForwardMovement = 0.05):
    ...
    def motorChange(self, value):
        self.position += abs(value) / 100000000
...
thread1.start()
d = Degas(motor, motorMax, gauge, frontend, ringCurrent)
d.updatePosition(0)
d.run()
d.report()
