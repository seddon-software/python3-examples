...
def setup():
    ...
    if available_ports:
        ...
        for channel in range(1, 1+1):
            pass
#             reset = [0xB0 + channel - 1, 123, 0]            
    ...
    def play(self):
        ...
        for [beat, midiMessage] in Midi.Sequence.sorted():
            ...
            if previousBeat != beat:
                ...
                print duration/quarterBeatsPerSec
                previousBeat = beat
...
#         self.instrument = instrument
    ...
    def noteOff(self, channel, note, velocity):
        ...
        Midi.Sequence.addMessage(self.beat, [byte1, note, 0])
