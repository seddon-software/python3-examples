...
o = object
class a(o): 
    def f(self): print "a",; super(a,self).f()
class b(o): 
    def f(self): print "b",; super(b,self).f()
class c(o): 
    def f(self): print "c",
class x(a): 
    def f(self): print "x",; super(x,self).f()
class y(a): 
    def f(self): print "y",; super(y,self).f()
class z(x,b,y,c): 
    def f(self): print "z",; super(z,self).f()
